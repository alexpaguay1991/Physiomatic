...
public class FrmClinicalHistoryDisplay extends javax.swing.JFrame {
    ...
    public FrmClinicalHistoryDisplay() {
        ...
        tblDiagnostic.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fecha del diagnóstico", "Patología", "Tratamiento", "Sintomas", "Alergias"
            }
        ));
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblPersonalInformation, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, -1, -1));

        lblName.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblName.setForeground(new java.awt.Color(255, 255, 255));
        lblName.setText("Nombre: ");
        getContentPane().add(lblName, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, -1, -1));

        txtName.setBackground(new java.awt.Color(0, 153, 153));
        txtName.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtName.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 80, 250, 30));

        lblLastName.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblLastName.setForeground(new java.awt.Color(255, 255, 255));
        lblLastName.setText("Apellido:");
        getContentPane().add(lblLastName, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 80, -1, -1));
        ...
        getContentPane().add(txtLastName, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 77, 250, 30));

        txtId.setEditable(false);
        txtId.setBackground(new java.awt.Color(0, 153, 153));
        txtId.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtId.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 120, 150, 30));

        lblId.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblId.setForeground(new java.awt.Color(255, 255, 255));
        lblId.setText("Cedula de identidad: ");
        getContentPane().add(lblId, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, -1, -1));

        lblAddress.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblAddress.setForeground(new java.awt.Color(255, 255, 255));
        lblAddress.setText("Dirección: ");
        getContentPane().add(lblAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 120, -1, -1));

        txtAddress.setBackground(new java.awt.Color(0, 153, 153));
        txtAddress.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtAddress.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(txtAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 120, 250, 30));

        lblEmail.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblEmail.setForeground(new java.awt.Color(255, 255, 255));
        lblEmail.setText("Correo electrónico:");
        getContentPane().add(lblEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, -1, -1));

        txtEmail.setBackground(new java.awt.Color(0, 153, 153));
        txtEmail.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtEmail.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 160, 230, 30));
        ...
        getContentPane().add(lblPhoneNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 160, -1, -1));
        ...
        getContentPane().add(txtPhoneNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 160, 150, 30));
        ...
        getContentPane().add(lblMedicalInformation, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 240, -1, -1));
        ...
        getContentPane().add(lblBloodType, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 280, -1, -1));
        ...
        getContentPane().add(txtBloodType, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 273, 80, 30));
        ...
        getContentPane().add(lblBirthDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, -1, 20));
        ...
        getContentPane().add(txtBirthDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 200, 150, 30));
        ...
        getContentPane().add(lblWeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 280, -1, -1));
        ...
        getContentPane().add(txtWeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 273, 70, 30));
        ...
        getContentPane().add(lblHeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 280, -1, -1));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 273, 70, 30));
        ...
        getContentPane().add(lblFamilyBackground, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 320, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 320, 430, 80));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 440, 690, 170));
        ...
        getContentPane().add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 640, -1, -1));
        ...
        getContentPane().add(btnExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 640, -1, -1));
        ...
        getContentPane().add(txtHeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 761, 690));
