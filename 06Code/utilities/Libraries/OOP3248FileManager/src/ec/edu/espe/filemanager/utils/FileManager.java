...
public class FileManager {
    ...
    public static void save(String fileName, String data){
     ...
     public static List<String> retrieveList(String fileName){
        ...
        ArrayList<Student> information2 = new ArrayList<>();
        try{
     ...
     public static void update(String fileName,String dataToFind, String datatoUpdate){
     ...
     public static void delete(String fileName, String datatodelete){
        List<String> lineInformation;
        lineInformation = retrieveList(fileName);
