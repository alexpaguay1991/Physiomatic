...
public class FrmAppointmentScheduling extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbnSave = new javax.swing.JToggleButton();
        ...
        tbnSave.setBackground(new java.awt.Color(0, 51, 51));
        tbnSave.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        tbnSave.setForeground(new java.awt.Color(255, 255, 255));
        tbnSave.setText("Guardar");
        tbnSave.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tbnSaveActionPerformed(evt);
            }
        });
        getContentPane().add(tbnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 220, -1, -1));
    ...
    private void tbnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tbnSaveActionPerformed
        ...
        if (selection == 0) {
            ...
            try {
                ...
                PhysiomaticController.createAppoinment(appointment);
                PhysiomaticController.addProductToConsumption(appointment.getPatient().getId(), "1404", "1");
                emptyFields();
    ...
    public Appointment getData() {
        ...
        Appointment appointment = new Appointment(dateOfAppointment, time, patient);
        return appointment;
    }
    ...
    private javax.swing.JToggleButton tbnSave;
