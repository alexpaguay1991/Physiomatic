...
public class FrmFirstAppointment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(spntime, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 80, 100, 30));
    ...
    private void tbnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tbnExitActionPerformed
        ...
        if (selection == 0) {
            ...
            try {
                ...
                PhysiomaticController.createConsumption(appointment.getPatient().getId(), "1404");
